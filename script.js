...
const HF_API_KEY = "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"; // Замените на ваш API ключ
    ...
    function showSubscribeModal(plan) {
        ...
        const planInfo = {
            ...
            premium: {
                ...
                description: "Полный доступ ко всем функциям MindBot без ограничений. Платите ежемесячно, отмена в любой момент. 990₽ в месяц.\n",
                price: "990₽ в месяц",
