    ...
    function showSubscribeModal(plan) {
        ...
        const planInfo = {
            ...
            premium: {
                ...
                description: "
                  Полный доступ ко всем функциям MindBot без ограничений. Платите ежемесячно, отмена в любой момент.",
                price: "990₽ в месяц
          ",
            ...
            annual: {
                ...
                description: "
                  Полный доступ на 1 год со скидкой 30%. Экономия 2,970₽ по сравнению с ежемесячной оплатой.",
                price: "7,900₽ в год
                    ",
                button: "Оформить подписку"
            }
